...
if not os.path.isfile("unigram-bigram_score_list_iter_%d.cPickle" % n_iter):
    binary_score_list = []
    tfidf_score_list = []
    ...
    pickle.dump((tfidf_score_list, binary_score_list), open("unigram-bigram_score_list_iter_%d.cPickle" % n_iter, 'wb'))
    print("Saved to file: %s" % "unigram-bigram_score_list_iter_%d.cPickle" % n_iter)
else:
    tfidf_score_list, binary_score_list = pickle.load(open("unigram-bigram_score_list_iter_%d.cPickle" % n_iter, 'rb'))
    print("Read from file: %s" % "unigram-bigram_score_list_iter_%d.cPickle" % n_iter)
